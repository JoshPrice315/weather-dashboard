var key = "95ee66a78799c385676571f931eee1b4";
var m = moment();
var todayDate = moment().format("MMMM Do YYYY");
var dayTwo = moment().add(1, "d").format("MMMM Do YYYY");
var dayThree = moment().add(2, "d").format("MMMM Do YYYY");
var dayFour = moment().add(3, "d").format("MMMM Do YYYY");
var dayFive = moment().add(4, "d").format("MMMM Do YYYY");
var daySix = moment().add(5, "d").format("MMMM Do YYYY");
